...
from rrt_pack.rrt.heuristics import planar_cost_to_go
from rrt_pack.rrt.heuristics import planar_segment_cost, planar_path_cost
...
class PlanarRRTStar(PlanarRRT):
    ...
    def get_nearby_vertices(self, tree, x_init, x_new):
        ...
        L_near = [(planar_path_cost(self.trees[tree].E, x_init, x_near, self.trees[tree].weights) + planar_segment_cost(x_near, x_new, self.trees[tree].weights), x_near) for
                  x_near in X_near]
